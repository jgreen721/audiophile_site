...
const Navbar = () => {
  const {appTheme, setAppTheme, showCart,setShowCart, hasCookies, toggleCookies, animate,setAnimate, showOptions, setShowOptions} = useAppContext();
  return (
    ...
    <Link className="nav-link" to="/earphones">Earphones</Link>
      ...
      <div className={showOptions ? "site-options-div" : "site-options-div hide-options-div"}>
        ...
        <div className="option-row">
        <p className="options-p">Cookies:{hasCookies ? "On" : "Off"}</p>
